// styled-components, axios, react-quill, next 등 필요한 라이브러리를 불러옵니다.
const React = require('react');
const styled = require('styled-components');
const axios = require('axios');
const NextPage = require('next').NextPage;

const ReactQuill = require('react-quill');
require('react-quill/dist/quill.snow.css');
const { RangeStatic } = require('quill');
...
// Editor 컴포넌트 정의
const Editor = NextPage(({ htmlStr, setHtmlStr }) => {
...
// CustomReactQuill 스타일드 컴포넌트 정의
const CustomReactQuill = styled(ReactQuill)`
    height: 300px;
`;

// 모듈을 외부에서 사용할 수 있도록 내보냅니다.
